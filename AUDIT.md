...
**7/10 capabilities** · cover 27 KB (500×666) · sampled 8 · failed 0 · bytes min 16 KB / avg 27 KB / median 28 KB / max 43 KB · dims avg 500×666 (max 500×712) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 31 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 2⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 24 KB (250×282) · sampled 8 · failed 0 · bytes min 12 KB / avg 24 KB / median 25 KB / max 31 KB · dims avg 250×282 (max 250×363) · aspect avg 0.93
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 307 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-09-12 by the nightly live audit ([`audit.ts`](audit.ts))._
