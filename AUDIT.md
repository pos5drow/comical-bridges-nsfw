...
**7/10 capabilities** · cover 25 KB (500×620) · sampled 8 · failed 0 · bytes min 14 KB / avg 25 KB / median 25 KB / max 33 KB · dims avg 500×620 (max 500×717) · aspect avg 0.88
...
**6/6 capabilities** · cover 24 KB (245×311) · sampled 8 · failed 0 · bytes min 12 KB / avg 24 KB / median 21 KB / max 39 KB · dims avg 245×311 (max 250×375) · aspect avg 0.85
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 282 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 123 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-08-28 by the nightly live audit ([`audit.ts`](audit.ts))._
