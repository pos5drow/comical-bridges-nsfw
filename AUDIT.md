...
**7/10 capabilities** · cover 31 KB (500×708) · sampled 8 · failed 0 · bytes min 24 KB / avg 31 KB / median 31 KB / max 35 KB · dims avg 500×708 (max 500×714) · aspect avg 0.71
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 29 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 21 KB (249×327) · sampled 8 · failed 0 · bytes min 9 KB / avg 21 KB / median 19 KB / max 34 KB · dims avg 249×327 (max 250×375) · aspect avg 0.84
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 609 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
