...
**7/10 capabilities** · cover 25 KB (500×695) · sampled 8 · failed 0 · bytes min 18 KB / avg 25 KB / median 24 KB / max 36 KB · dims avg 500×695 (max 500×707) · aspect avg 0.72
...
**6/6 capabilities** · cover 25 KB (250×325) · sampled 8 · failed 0 · bytes min 19 KB / avg 25 KB / median 25 KB / max 30 KB · dims avg 250×325 (max 250×375) · aspect avg 0.81
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 474 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-08-13 by the nightly live audit ([`audit.ts`](audit.ts))._
