...
**7/10 capabilities** · cover 31 KB (500×622) · sampled 8 · failed 0 · bytes min 18 KB / avg 31 KB / median 33 KB / max 47 KB · dims avg 500×622 (max 500×710) · aspect avg 0.87
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 51 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 2⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 19 KB (247×294) · sampled 8 · failed 0 · bytes min 13 KB / avg 19 KB / median 20 KB / max 24 KB · dims avg 247×294 (max 250×375) · aspect avg 0.89
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 519 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-09-23 by the nightly live audit ([`audit.ts`](audit.ts))._
