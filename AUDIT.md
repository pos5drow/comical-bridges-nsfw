...
**7/10 capabilities** · cover 32 KB (500×706) · sampled 8 · failed 0 · bytes min 26 KB / avg 32 KB / median 32 KB / max 37 KB · dims avg 500×706 (max 500×721) · aspect avg 0.71
...
**6/6 capabilities** · cover 23 KB (250×300) · sampled 8 · failed 0 · bytes min 17 KB / avg 23 KB / median 23 KB / max 29 KB · dims avg 250×300 (max 250×375) · aspect avg 0.92
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 58 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 328 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-09-15 by the nightly live audit ([`audit.ts`](audit.ts))._
