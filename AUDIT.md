...
**7/10 capabilities** · cover 25 KB (500×662) · sampled 8 · failed 0 · bytes min 16 KB / avg 25 KB / median 25 KB / max 32 KB · dims avg 500×662 (max 500×706) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 88 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 22 KB (247×321) · sampled 8 · failed 0 · bytes min 14 KB / avg 22 KB / median 24 KB / max 30 KB · dims avg 247×321 (max 250×375) · aspect avg 0.83
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 84 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 182 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 79 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
