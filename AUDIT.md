...
**7/10 capabilities** · cover 26 KB (500×706) · sampled 8 · failed 0 · bytes min 14 KB / avg 26 KB / median 25 KB / max 47 KB · dims avg 500×706 (max 500×717) · aspect avg 0.71
...
**6/6 capabilities** · cover 23 KB (250×268) · sampled 8 · failed 0 · bytes min 14 KB / avg 23 KB / median 22 KB / max 37 KB · dims avg 250×268 (max 250×365) · aspect avg 1.05
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 81 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 587 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
