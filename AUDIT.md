...
**7/10 capabilities** · cover 33 KB (500×656) · sampled 8 · failed 0 · bytes min 22 KB / avg 33 KB / median 31 KB / max 47 KB · dims avg 500×656 (max 500×714) · aspect avg 0.80
...
**6/6 capabilities** · cover 22 KB (240×311) · sampled 8 · failed 0 · bytes min 16 KB / avg 22 KB / median 22 KB / max 28 KB · dims avg 240×311 (max 250×375) · aspect avg 0.85
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 880 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-09-13 by the nightly live audit ([`audit.ts`](audit.ts))._
