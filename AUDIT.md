...
**7/10 capabilities** · cover 27 KB (500×613) · sampled 8 · failed 0 · bytes min 6 KB / avg 27 KB / median 30 KB / max 37 KB · dims avg 500×613 (max 500×835) · aspect avg 0.98
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 28 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 22 KB (250×328) · sampled 8 · failed 0 · bytes min 15 KB / avg 22 KB / median 23 KB / max 27 KB · dims avg 250×328 (max 250×365) · aspect avg 0.80
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 62 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 1840 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 155 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-09-16 by the nightly live audit ([`audit.ts`](audit.ts))._
