...
**7/10 capabilities** · cover 27 KB (500×626) · sampled 8 · failed 0 · bytes min 11 KB / avg 27 KB / median 25 KB / max 41 KB · dims avg 500×626 (max 500×725) · aspect avg 0.86
...
**6/6 capabilities** · cover 19 KB (250×298) · sampled 8 · failed 0 · bytes min 11 KB / avg 19 KB / median 19 KB / max 30 KB · dims avg 250×298 (max 250×375) · aspect avg 0.93
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 60 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 117 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 465 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-08-04 by the nightly live audit ([`audit.ts`](audit.ts))._
