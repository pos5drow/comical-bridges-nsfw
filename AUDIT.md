...
**7/10 capabilities** · cover 32 KB (500×659) · sampled 8 · failed 0 · bytes min 17 KB / avg 32 KB / median 33 KB / max 49 KB · dims avg 500×659 (max 500×710) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 69 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 20 KB (250×325) · sampled 8 · failed 0 · bytes min 10 KB / avg 20 KB / median 20 KB / max 29 KB · dims avg 250×325 (max 250×366) · aspect avg 0.85
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 82 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 358 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 5 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-08-12 by the nightly live audit ([`audit.ts`](audit.ts))._
