...
**7/10 capabilities** · cover 28 KB (500×705) · sampled 8 · failed 0 · bytes min 20 KB / avg 28 KB / median 27 KB / max 37 KB · dims avg 500×705 (max 500×709) · aspect avg 0.71
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 93 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 1⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 23 KB (250×324) · sampled 8 · failed 0 · bytes min 14 KB / avg 23 KB / median 22 KB / max 29 KB · dims avg 250×324 (max 250×375) · aspect avg 0.82
