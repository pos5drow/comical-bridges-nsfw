...
**7/10 capabilities** · cover 25 KB (500×581) · sampled 8 · failed 0 · bytes min 16 KB / avg 25 KB / median 24 KB / max 39 KB · dims avg 500×581 (max 500×707) · aspect avg 0.94
...
**6/6 capabilities** · cover 23 KB (250×307) · sampled 8 · failed 0 · bytes min 17 KB / avg 23 KB / median 21 KB / max 33 KB · dims avg 250×307 (max 250×375) · aspect avg 0.84
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 1573 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
