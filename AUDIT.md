...
**7/10 capabilities** · cover 26 KB (500×577) · sampled 8 · failed 0 · bytes min 16 KB / avg 26 KB / median 26 KB / max 36 KB · dims avg 500×577 (max 500×708) · aspect avg 0.95
...
**6/6 capabilities** · cover 25 KB (250×325) · sampled 8 · failed 0 · bytes min 17 KB / avg 25 KB / median 25 KB / max 31 KB · dims avg 250×325 (max 250×375) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 178 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 794 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
