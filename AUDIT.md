...
**7/10 capabilities** · cover 24 KB (500×650) · sampled 8 · failed 0 · bytes min 9 KB / avg 24 KB / median 21 KB / max 54 KB · dims avg 500×650 (max 500×723) · aspect avg 0.86
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 52 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 22 KB (250×264) · sampled 8 · failed 0 · bytes min 12 KB / avg 22 KB / median 23 KB / max 32 KB · dims avg 250×264 (max 250×357) · aspect avg 1.09
