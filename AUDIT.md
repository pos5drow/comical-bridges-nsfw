...
**7/10 capabilities** · cover 27 KB (500×662) · sampled 8 · failed 0 · bytes min 19 KB / avg 27 KB / median 27 KB / max 35 KB · dims avg 500×662 (max 500×708) · aspect avg 0.79
...
**6/6 capabilities** · cover 21 KB (250×353) · sampled 8 · failed 0 · bytes min 16 KB / avg 21 KB / median 20 KB / max 28 KB · dims avg 250×353 (max 250×375) · aspect avg 0.71
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 500 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-09-24 by the nightly live audit ([`audit.ts`](audit.ts))._
