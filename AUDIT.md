...
**7/10 capabilities** · cover 20 KB (500×665) · sampled 8 · failed 0 · bytes min 12 KB / avg 20 KB / median 17 KB / max 32 KB · dims avg 500×665 (max 500×714) · aspect avg 0.79
...
**6/6 capabilities** · cover 22 KB (250×275) · sampled 8 · failed 0 · bytes min 15 KB / avg 22 KB / median 22 KB / max 30 KB · dims avg 250×275 (max 250×365) · aspect avg 0.97
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 1005 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 8 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-09-01 by the nightly live audit ([`audit.ts`](audit.ts))._
