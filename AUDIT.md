...
**7/10 capabilities** · cover 25 KB (500×539) · sampled 8 · failed 0 · bytes min 15 KB / avg 25 KB / median 24 KB / max 40 KB · dims avg 500×539 (max 500×706) · aspect avg 1.02
...
**6/6 capabilities** · cover 28 KB (245×364) · sampled 8 · failed 0 · bytes min 20 KB / avg 28 KB / median 24 KB / max 43 KB · dims avg 245×364 (max 250×375) · aspect avg 0.67
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 107 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 78 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-08-22 by the nightly live audit ([`audit.ts`](audit.ts))._
