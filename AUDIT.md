...
**7/10 capabilities** · cover 32 KB (500×703) · sampled 8 · failed 0 · bytes min 22 KB / avg 32 KB / median 29 KB / max 59 KB · dims avg 500×703 (max 500×709) · aspect avg 0.71
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 45 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 18 KB (246×302) · sampled 8 · failed 0 · bytes min 11 KB / avg 18 KB / median 17 KB / max 28 KB · dims avg 246×302 (max 250×375) · aspect avg 0.87
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 86 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-09-19 by the nightly live audit ([`audit.ts`](audit.ts))._
