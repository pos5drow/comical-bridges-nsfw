...
**7/10 capabilities** · cover 27 KB (500×657) · sampled 8 · failed 0 · bytes min 14 KB / avg 27 KB / median 27 KB / max 39 KB · dims avg 500×657 (max 500×707) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 64 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 21 KB (250×240) · sampled 8 · failed 0 · bytes min 11 KB / avg 21 KB / median 21 KB / max 29 KB · dims avg 250×240 (max 250×354) · aspect avg 1.13
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 52 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 473 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 89 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
