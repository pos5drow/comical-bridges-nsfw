...
**7/10 capabilities** · cover 23 KB (500×582) · sampled 8 · failed 0 · bytes min 15 KB / avg 23 KB / median 23 KB / max 33 KB · dims avg 500×582 (max 500×707) · aspect avg 0.94
...
**6/6 capabilities** · cover 19 KB (250×280) · sampled 8 · failed 0 · bytes min 11 KB / avg 19 KB / median 19 KB / max 31 KB · dims avg 250×280 (max 250×375) · aspect avg 1.03
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 410 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 83 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-08-23 by the nightly live audit ([`audit.ts`](audit.ts))._
