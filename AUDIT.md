...
**7/10 capabilities** · cover 28 KB (500×662) · sampled 8 · failed 0 · bytes min 18 KB / avg 28 KB / median 25 KB / max 42 KB · dims avg 500×662 (max 500×709) · aspect avg 0.79
...
**6/6 capabilities** · cover 21 KB (250×317) · sampled 8 · failed 0 · bytes min 9 KB / avg 21 KB / median 23 KB / max 32 KB · dims avg 250×317 (max 250×375) · aspect avg 0.85
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 56 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 1793 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 273 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
