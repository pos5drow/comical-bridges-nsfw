...
**7/10 capabilities** · cover 31 KB (500×631) · sampled 8 · failed 0 · bytes min 9 KB / avg 31 KB / median 29 KB / max 54 KB · dims avg 500×631 (max 500×889) · aspect avg 0.93
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 24 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (11✓ 3⚠ 1✗ 1⊘)

**6/6 capabilities** · cover 22 KB (250×342) · sampled 8 · failed 0 · bytes min 13 KB / avg 22 KB / median 22 KB / max 29 KB · dims avg 250×342 (max 250×375) · aspect avg 0.76

> flaky (tolerated): sad-panda / IP + cookie gated from datacenters

| Result | Check | Capability | Detail |
|:--:|---|---|---|
| ✗ | `lists.idStability` | lists | list "popular" item ids are not stable across identical calls |
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 77 item(s) |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 299 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 62 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
