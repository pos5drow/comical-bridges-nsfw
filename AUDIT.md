...
**7/10 capabilities** · cover 22 KB (500×666) · sampled 8 · failed 0 · bytes min 12 KB / avg 22 KB / median 23 KB / max 36 KB · dims avg 500×666 (max 500×712) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 80 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 1⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 25 KB (250×334) · sampled 8 · failed 0 · bytes min 19 KB / avg 25 KB / median 22 KB / max 37 KB · dims avg 250×334 (max 250×365) · aspect avg 0.76
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 81 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 19 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

_Updated 2026-09-17 by the nightly live audit ([`audit.ts`](audit.ts))._
