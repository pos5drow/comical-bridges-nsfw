...
**7/10 capabilities** · cover 30 KB (500×663) · sampled 8 · failed 0 · bytes min 16 KB / avg 30 KB / median 28 KB / max 47 KB · dims avg 500×663 (max 500×709) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 134 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 21 KB (250×320) · sampled 8 · failed 0 · bytes min 14 KB / avg 21 KB / median 22 KB / max 26 KB · dims avg 250×320 (max 250×368) · aspect avg 0.84
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 1841 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
_Updated 2026-09-11 by the nightly live audit ([`audit.ts`](audit.ts))._
