...
**7/10 capabilities** · cover 30 KB (500×620) · sampled 8 · failed 0 · bytes min 12 KB / avg 30 KB / median 28 KB / max 47 KB · dims avg 500×620 (max 500×709) · aspect avg 0.88
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 201 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 20 KB (240×328) · sampled 8 · failed 0 · bytes min 12 KB / avg 20 KB / median 19 KB / max 26 KB · dims avg 240×328 (max 250×375) · aspect avg 0.76
...
_Updated 2026-09-14 by the nightly live audit ([`audit.ts`](audit.ts))._
