...
**7/10 capabilities** · cover 26 KB (500×665) · sampled 8 · failed 0 · bytes min 19 KB / avg 26 KB / median 26 KB / max 33 KB · dims avg 500×665 (max 500×714) · aspect avg 0.79
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 15 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |

## `e-hentai` — ⚠ (12✓ 3⚠ 0✗ 1⊘)

**6/6 capabilities** · cover 20 KB (237×351) · sampled 8 · failed 0 · bytes min 15 KB / avg 20 KB / median 19 KB / max 30 KB · dims avg 237×351 (max 250×375) · aspect avg 0.68
...
| ✓ | `lists.catalog` | lists | getLists returned 2 list(s) |
| ✓ | `lists.items` | lists | list "popular" returned 64 item(s) |
| ✓ | `lists.idStability` | lists | list item ids are stable across calls |
| ✓ | `lists.cursor` | lists | single page (no nextCursor) |
| ✓ | `search.items` | search | search returned 25 item(s) |
| ✓ | `search.cursor` | search | nextCursor advanced to 25 further item(s) |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 994 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
...
| ✓ | `direct.pages` | direct | getSeriesPages returned 68 page(s) |
| ✓ | `read.detailsRoundTrip` | core | details round-trip the sampled id |
