...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 32 KB (500×706) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 3⚠ 0✗ 1⊘) | 6/6 | 23 KB (250×300) | sad-panda / IP + cookie gated from datacenters |
