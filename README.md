...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 3⚠ 0✗ 2⊘) | 7/10 | 26 KB (500×577) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 2⚠ 0✗ 1⊘) | 6/6 | 25 KB (250×325) | sad-panda / IP + cookie gated from datacenters |
