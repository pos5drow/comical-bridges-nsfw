...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 31 KB (500×631) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (11✓ 3⚠ 1✗ 1⊘) | 6/6 | 22 KB (250×342) | flaky (tolerated): sad-panda / IP + cookie gated from datacenters |
