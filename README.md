...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 27 KB (500×626) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 2⚠ 0✗ 1⊘) | 6/6 | 19 KB (250×298) | sad-panda / IP + cookie gated from datacenters |
