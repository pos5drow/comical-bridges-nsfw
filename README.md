...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 29 KB (500×689) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 1⚠ 0✗ 1⊘) | 6/6 | 24 KB (250×308) | sad-panda / IP + cookie gated from datacenters |
