...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 26 KB (500×672) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 3⚠ 0✗ 1⊘) | 6/6 | 19 KB (244×306) | sad-panda / IP + cookie gated from datacenters |
| `hitomi` | ✓ (12✓ 0⚠ 0✗ 1⊘) | 5/8 | — | images need the host /img-proxy (Referer-gated), unavailable in the audit |
