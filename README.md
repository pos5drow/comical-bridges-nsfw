...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 22 KB (500×666) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 1⚠ 0✗ 1⊘) | 6/6 | 25 KB (250×334) | sad-panda / IP + cookie gated from datacenters |
| `hitomi` | ⚠ (13✓ 1⚠ 0✗) | 5/8 | — | images need the host /img-proxy (Referer-gated), unavailable in the audit |
