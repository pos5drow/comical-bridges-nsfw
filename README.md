...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 28 KB (500×719) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 3⚠ 0✗ 1⊘) | 6/6 | 20 KB (250×279) | sad-panda / IP + cookie gated from datacenters |
