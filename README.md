...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 27 KB (500×590) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 1⚠ 0✗ 1⊘) | 6/6 | 27 KB (250×345) | sad-panda / IP + cookie gated from datacenters |
