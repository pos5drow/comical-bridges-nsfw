...
|---|---|---|---|---|
| `nhentai` | ⚠ (13✓ 2⚠ 0✗ 2⊘) | 7/10 | 31 KB (500×622) | Cloudflare / IP-gated from datacenters |
| `e-hentai` | ⚠ (12✓ 2⚠ 0✗ 1⊘) | 6/6 | 19 KB (247×294) | sad-panda / IP + cookie gated from datacenters |
